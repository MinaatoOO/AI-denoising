...
for i in range(len(clean_files)):
    if clean_files[i] in ['1237.flac','1435.flac','1421.flac']:
...
for idx in random_indices:
    ...
    clean_spectrogram, _ = create_spectrogram_with_phase(clean)
    ...
    audio_predicted = spectrogram_to_audio_with_phase(predicted_spectrogram, original_phase)
